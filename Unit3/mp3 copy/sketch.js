...
class Bottle {
  // constructor and attributes
  constructor() {
    this.pos = createVector(0, random(height)); // initialize your attributes here
    this.velocity = createVector(random(-3,0), 0);
    // this.r = random(255);
    // this.g = random(255);
    // this.b = random(255);
    // this.o = random(100);
  ...
  display() {
    // this can be text, images, or shapes
     image(bottle,this.pos.x, this.pos.y);
  }
...
class Can {
  ...
  display() {
    // this can be text, images, or shapes
     image(can,this.pos.x, this.pos.y);
  }
...
class Worm {
  ...
  display() {
    // this can be text, images, or shapes
     image(worm,this.pos.x, this.pos.y);
  }
